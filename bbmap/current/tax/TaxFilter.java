...
public class TaxFilter {
	...
	public static TaxFilter makeFilter(String[] args){
		...
		TaxFilter filter=new TaxFilter(tableFile, treeFile, accessionFile, taxLevel, reqLevels, include, null, regex, contains);
	...
	public boolean addNode(TaxNode tn){
		if(tn==null || (taxLevel>-1 && tn.level>taxLevel)){return false;}
		taxSet.add(tn.id);
