...
public class TestFilesystem {
	...
	private static void log(final long time, final long copyTime, final long metaTime){
		...
		sb.append(String.format("%.2f", size*1000/Tools.max(1, (double)copyTime))).append('\t');
		sb.append(filesToCreate*3).append('\t');
		sb.append(metaTime/1000000).append('\t');
		sb.append(String.format("%.2f", (3*filesToCreate)*1000000000L/Tools.max(1, (double)metaTime))).append('\t');
