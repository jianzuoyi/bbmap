...
//				System.err.println(a+", "+b);
		...
		public String toString(){
			...
			sb.append('\t').append(String.format("%.2f", WKID));
			sb.append('\t').append(String.format("%.2f", KID));
			sb.append('\t').append(String.format("%.2f", ANI));
			sb.append('\t').append(String.format("%.2f", Complt));
			sb.append('\t').append(String.format("%.2f", Contam));
			sb.append('\t').append(TaxID);
			sb.append('\t').append(TaxName);
			sb.append('\t').append(topContamID);
			sb.append('\t').append(topContamName);
