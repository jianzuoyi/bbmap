...
public class Blacklist extends SketchObject {
	...
	private static ArrayList<Sketch> addFile(String fname){
		...
		added.add(fname);
		SketchTool tool=new SketchTool(1000000, 1);
		ArrayList<Sketch> sketches=tool.loadSketches(fname, null, ONE_SKETCH, 1f, -1);
		return sketches;
	}
	...
	static String ntBlacklist=Data.findPath("?blacklist_nt_species_1000.sketch");
	static String silvaBlacklist=Data.findPath("?blacklist_silva_species_500.sketch");
	static String refseqBlacklist=Data.findPath("?blacklist_refseq_species_300.sketch");
	static String imgBlacklist=Data.findPath("?blacklist_img_species_300.sketch");
	static String nrBlacklist=null;//Data.findPath("?blacklist_nr_species_1000.sketch");
