...
chloro=f            Remove chloroplast reads.
mito=f              Remove mitochondrial reads.
...
Sketch parameters:
sketch=t            Run SendSketch versus nt, RefSeq, and Silva on 500k reads.
...
sketchsamplerate=0.5   Samplerate for SendSketch.
